...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigArducopter : MyUserControl, IActivate
    {
        ...
        public void Activate()
        {
            ...
            HLD_LAT_P.setup(0, 0, 1, 0.001f, new[] {"HLD_LAT_P", "POS_XY_P", "PSC_NE_POS_P", "PSC_POSXY_P", "Q_P_POSXY_P", "Q_P_NE_POS_P"},
                MainV2.comPort.MAV.param);
            LOITER_LAT_D.setup(0, 0, 1, 0.001f, new[] {"LOITER_LAT_D", "PSC_NE_VEL_D", "PSC_VELXY_D", "Q_P_VELXY_D", "Q_P_NE_VEL_D"},
                MainV2.comPort.MAV.param);
            LOITER_LAT_I.setup(0, 0, 1, 0.001f, new[] {"LOITER_LAT_I", "VEL_XY_I", "PSC_NE_VEL_I", "PSC_VELXY_I", "Q_P_VELXY_I", "Q_P_NE_VEL_I"},
                MainV2.comPort.MAV.param);
            LOITER_LAT_IMAX.setup(0, 0, 10, 1f,
                new[] {"LOITER_LAT_IMAX", "VEL_XY_IMAX", "PSC_NE_VEL_IMAX", "PSC_VELXY_IMAX", "Q_P_VELXY_IMAX", "Q_P_NE_VEL_IMAX"},
                MainV2.comPort.MAV.param);
            LOITER_LAT_P.setup(0, 0, 1, 0.001f, new[] {"LOITER_LAT_P", "VEL_XY_P", "PSC_NE_VEL_P", "PSC_VELXY_P", "Q_P_VELXY_P", "Q_P_NE_VEL_P"},
                MainV2.comPort.MAV.param);
            ...
            THR_ACCEL_P.setup(0, 0, 1, 0.001f, new[] { "THR_ACCEL_P", "ACCEL_Z_P", "PSC_D_ACC_P", "PSC_ACCZ_P", "Q_P_ACCZ_P", "Q_P_D_ACC_P" },
                MainV2.comPort.MAV.param);
            THR_ACCEL_I.setup(0, 0, 1, 0.001f, new[] { "THR_ACCEL_I", "ACCEL_Z_I", "PSC_D_ACC_I", "PSC_ACCZ_I", "Q_P_ACCZ_I", "Q_P_D_ACC_I" },
                MainV2.comPort.MAV.param);
            THR_ACCEL_D.setup(0, 0, 1, 0.001f, new[] {"THR_ACCEL_D", "ACCEL_Z_D", "PSC_D_ACC_D", "PSC_ACCZ_D", "Q_P_ACCZ_D", "Q_P_D_ACC_D"},
                MainV2.comPort.MAV.param);
            THR_ACCEL_IMAX.setup(0, 0, 10, 1f, new[] {"THR_ACCEL_IMAX", "ACCEL_Z_IMAX", "PSC_D_ACC_IMAX", "PSC_ACCZ_IMAX", "Q_P_ACCZ_IMAX", "Q_P_D_ACC_IMAX"},
                MainV2.comPort.MAV.param);

            THR_ALT_P.setup(0, 0, 1, 0.001f, new[] {"THR_ALT_P", "POS_Z_P", "PSC_D_POS_P", "PSC_POSZ_P", "Q_P_POSZ_P", "Q_P_D_POS_P"},
                MainV2.comPort.MAV.param);
            THR_RATE_P.setup(0, 0, 1, 0.001f, new[] {"THR_RATE_P", "VEL_Z_P", "PSC_D_VEL_P", "PSC_VELZ_P", "Q_P_VELZ_P", "Q_P_D_VEL_P"},
                MainV2.comPort.MAV.param);

            WPNAV_LOIT_SPEED.setup(0, 0, 1, 0.001f, new[] {"WPNAV_LOIT_SPEED", "LOIT_SPEED_MS", "LOIT_SPEED", "Q_LOIT_SPEED", "Q_LOIT_SPEED_MS"},
                MainV2.comPort.MAV.param);
            WPNAV_RADIUS.setup(0, 0, 1, 0.001f, new[] {"WP_RADIUS_M", "WPNAV_RADIUS", "Q_WP_RADIUS", "Q_WP_RADIUS_M"}, MainV2.comPort.MAV.param);
            WPNAV_SPEED.setup(0, 0, 1, 0.001f, new[] {"WP_SPD", "WPNAV_SPEED", "Q_WP_SPEED", "Q_WP_SPD"}, MainV2.comPort.MAV.param);
            WPNAV_SPEED_DN.setup(0, 0, 1, 0.001f, new[] {"WP_SPD_DN", "WPNAV_SPEED_DN", "Q_WP_SPEED_DN", "Q_WP_SPD_DN"}, MainV2.comPort.MAV.param);
            WPNAV_SPEED_UP.setup(0, 0, 1, 0.001f, new[] {"WP_SPD_UP", "WPNAV_SPEED_UP", "Q_WP_SPEED_UP", "Q_WP_SPD_UP"}, MainV2.comPort.MAV.param);
            ...
            mavlinkNumericUpDownatc_accel_r_max.setup(0, 0, 1, 0.001f, new[] {"ATC_ACC_R_MAX", "ATC_ACCEL_R_MAX", "Q_A_ACCEL_R_MAX", "Q_A_ACC_R_MAX"},
                MainV2.comPort.MAV.param);
            mavlinkNumericUpDownatc_accel_p_max.setup(0, 0, 1, 0.001f, new[] {"ATC_ACC_P_MAX", "ATC_ACCEL_P_MAX", "Q_A_ACCEL_P_MAX", "Q_A_ACC_P_MAX"},
                MainV2.comPort.MAV.param);
            mavlinkNumericUpDownatc_accel_y_max.setup(0, 0, 1, 0.001f, new[] {"ATC_ACC_Y_MAX", "ATC_ACCEL_Y_MAX", "Q_A_ACCEL_Y_MAX", "Q_A_ACC_Y_MAX"},
                MainV2.comPort.MAV.param);
